...
@section('page-icon')
<x-admin.icon name="qr" class="w-5 h-5 text-amber-400" />
@endsection
...
<div class="space-y-6 pt-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="w-32 h-32 bg-white rounded-xl flex items-center justify-center flex-shrink-0 border-2 border-gold-400/30 overflow-hidden">
                ...
                @else
                    <div class="text-center p-2">
                        <div class="mb-1 flex justify-center text-blue-400"><x-admin.icon name="qr" class="w-8 h-8" /></div>
        ...
        <div class="admin-card p-10 col-span-2 text-center text-gray-500">
            <div class="mb-4 opacity-30 flex justify-center"><x-admin.icon name="qr" class="w-12 h-12" /></div>
